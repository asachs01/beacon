...
// Build timestamp is injected by the build script; falls back to 'dev' for local dev
const BUILD_ID = '__BUILD_TIME__' === '__BUILD_' + 'TIME__' ? 'dev' : '__BUILD_TIME__';
const CACHE_NAME = `beacon-v1-${BUILD_ID}`;
