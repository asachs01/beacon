...
categories: ["overview"]
tags: ["beacon", "family", "dashboard", "home-assistant"]
slug: "welcome"
draft: false
---
...
_Screenshots of each view will be added here._

<!-- TODO: Add screenshots
- Dashboard view (clock, greeting, today's events, weather, tasks, countdown)
- Calendar week view (events, drag-and-drop, all-day section)
- Chores panel (member groups, progress bars, streaks)
- Leaderboard (ranked earnings, weekly/monthly toggle)
- Music view (album art, controls, player selector)
- Photo frame (slideshow with clock overlay)
- Family manager (avatar picker, color selection, roles)
- Theme selector (all 7 themes in dropdown)
-->
