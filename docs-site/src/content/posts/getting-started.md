...
- [Calendar](/docs/calendar/) — creating events, recurring events, drag-to-reschedule
- [Dashboard](/docs/dashboard/) — understanding the dashboard layout
- [Family Members](/docs/family/) — managing family members
- [Configuration](/docs/configuration/) — complete options reference
- [Themes](/docs/themes/) — changing the look and feel
