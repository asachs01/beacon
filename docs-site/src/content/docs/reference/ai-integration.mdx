...
| `beacon_create_chore` | Create a new chore | `name`; optional: `assigned_to` (array of member names), `frequency` (daily/weekly/once), `value_cents`, `icon` |
| `beacon_update_chore` | Update an existing chore | `chore_name`; optional: `name`, `assigned_to`, `frequency`, `value_cents`, `icon` |
| `beacon_delete_chore` | Delete a chore and its completions | `chore_name` |
| `beacon_list_chores` | List all chores with today's completion status | (none) |
