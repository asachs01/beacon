...
## Managing Chores with AI and Voice

The Beacon MCP server supports full chore CRUD — LLMs like Claude, Open Claw, and others can create, update, delete, and list chores on your behalf through natural language.

For example, you can say: "Hey, create a chore for Lennon to feed the dog every day, worth $1" and the LLM will handle the rest.

See the [AI and Voice Control](/docs/reference/ai-integration/) reference for the complete list of chore tools and setup instructions.

Home Assistant Assist voice commands also support chore completion out of the box. Say things like "Mark dishes as done" or "Alex finished vacuuming" through any Assist-enabled device.
...
You need to add at least one family member before you can create or view chores. See [Family Members](/docs/features/family/).
