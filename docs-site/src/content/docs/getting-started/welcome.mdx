...
Ready to set up Beacon? Head to the [Getting Started guide](/docs/getting-started/installation/) to install the add-on and connect your first calendar in under 10 minutes.
...
| Guide | Description |
|-------|-------------|
| [Getting Started](/docs/getting-started/installation/) | Installation, setup, and first-time configuration |
| [Calendar](/docs/features/calendar/) | Week view, creating events, recurring events, drag-to-reschedule |
| [Dashboard](/docs/features/dashboard/) | Clock, weather, tasks, countdown widget |
| [Family Members](/docs/features/family/) | Adding members, avatars, colors, roles, PINs |
| [Chores](/docs/features/chores/) | Creating chores, values, streaks, leaderboard |
| [Grocery](/docs/features/grocery/) | Grocy and AnyList integration, shopping lists |
| [Music](/docs/features/music/) | Media player controls, Now Playing bar |
| [Photos](/docs/features/photos/) | Photo frame, slideshow, overlays |
| [Themes](/docs/customization/themes/) | All 7 themes, auto dark mode, custom themes |
| [Timer](/docs/features/timer/) | Countdown and stopwatch modes |
| [Notifications](/docs/features/notifications/) | Browser and mobile push notifications |
| [Screen Saver](/docs/features/screensaver/) | Dim mode, clock screensaver, anti-burn-in |
| [Configuration](/docs/customization/configuration/) | Complete options reference |
| [Deployment](/docs/getting-started/deployment/) | Docker, reverse proxy, kiosk mode, hardware |
| [FAQ](/docs/reference/faq/) | 20+ common questions answered |
| [AI and Voice Control](/docs/reference/ai-integration/) | Voice API, MCP server, HA Assist custom sentences |
| [API Reference](/docs/reference/api-reference/) | WebSocket API, calendar, weather, media |
| [Contributing](/docs/reference/contributing/) | Architecture, development setup, adding features |
